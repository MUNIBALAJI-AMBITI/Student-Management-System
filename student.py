...
listStd = ["Muni Balaji", "luffy", "zoro"] #List Of Students
...
Enter 4 : To Remove Student 
	...
	try: #Using Exceptions For Validation
		...
		exit("\nWrong input select from the above given options") #Error Message
	else:
		print("\n") #Print New Line
	...
	if(userInput == 1): #This Option Will Print List Of Students
		...
		newStd = input("Enter New Student Name: ")
		...
		if(srcStd in listStd): #This Condition Searching The Student
			print("\n=> Student Record {} Found ".format(srcStd))
		else:
			print("\n=> Student Record {} Not Found ".format(srcStd)) #Error Message
		...
		if(rmStd in listStd): #This Condition Removing The Student From The List 
			...
			print("\n=> Student {} Records Successfully Deleted \n".format(rmStd))
			for students in listStd:
				print("=> {}".format(students))
		else:
			print("\n=> No Records Found of This Student {}".format(rmStd)) #Error Message
